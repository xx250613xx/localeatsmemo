...
export default function Header() {
    ...
    return (
        <header className="bg-brand-dark text-white p-4">
            ...
            <nav>
                <ul className="flex flex-col space-y-2 md:flex-row md:space-y-0 md:space-x-4 bg-brand p-2 rounded">
                    {
                        allpage.map((page) => {
                            return (
                                <li key={page} className="bg-brand-dark rounded-md p-2 md:p-1 w-full md:w-auto">
